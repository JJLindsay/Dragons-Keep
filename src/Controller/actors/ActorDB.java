...
//    //instance variables
    ...
    public Boolean saveHeroData(String heroAttributes)
    {
        ...
        if (err == 0)
        {
            new View().setControllerDisplay("There was an error in updating saved Hero Data to playerFile");
            return false;
        }
        else
        {
            new View().setControllerDisplay("Successfully saved Hero profile to the database.");
        }
        return true;
    }
}